...
public class AppPosVerticle extends Application {
    ...
    //標記來記錄結帳狀態
    private boolean isCheckoutCompleted = false;

    private Button btn_two_k;
    private Button btn_one_k;
    private Button btn_five_h;
    private Button btn_two_h;
    private Button btn_one_h;
